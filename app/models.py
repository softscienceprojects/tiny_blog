...
class PaginatedAPIMixin(object):
    @staticmethod
    def to_collection_dict(query, page, per_page, endpoint, **kwargs): #first three SQLAlchemy query objects
...
class User(PaginatedAPIMixin, UserMixin, db.Model):
    ...
    def to_dict(self, include_email=False):
        data = {
            ...
            'last_seen': self.last_seen.isoformat() + 'Z', #ISO8601
    ...
    def from_dict(self, new_user=False):
